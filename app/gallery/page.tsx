        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Relive the memorable moments from Global MUN conferences. Browse through committee sessions, networking
        ...
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join us at the next Global MUN conference and become part of these unforgettable moments. Register now to
